...
class PublicHomeaLmrS0Ej8EeaK4_MRcoLfnw extends dime.DIMEComponent implements OnInit, OnDestroy, AfterViewInit {
  	...
  	// branch Play as info.scce.dime.gui.editor.graphiti.api.CButton@bfa425e4 (id: _MF6_kE_LEeauEZ95mLTQ7g) in info.scce.dime.gui.editor.graphiti.api.CGUI@e567f1e5 (id: _LmrS0Ej8EeaK4_MRcoLfnw)
	...
	void ngAfterViewInit() {
		...
		js.context.callMethod("enableTooltip",[]);
  		...
  		/// callback, if the button Play is clicked
  			void actionplayeventaMF6_kE_LEeauEZ95mLTQ7gEventTrigger()
  		...
  		String loada9NZskW8LEe2hmY3gzoFrzAImage(fileRef)
  		{
  			//prepare guard compound
  			FileGuarda9NZskW8LEe2hmY3gzoFrzACompound guardContainer = new FileGuarda9NZskW8LEe2hmY3gzoFrzACompound();
  		...
  		/// loads an image file download for an image component	
  		String loada89xVIW8LEe2hmY3gzoFrzAImage(fileRef)
  		{
  			//prepare guard compound
  			FileGuarda89xVIW8LEe2hmY3gzoFrzACompound guardContainer = new FileGuarda89xVIW8LEe2hmY3gzoFrzACompound();
  			guardContainer.context = fileRef;
