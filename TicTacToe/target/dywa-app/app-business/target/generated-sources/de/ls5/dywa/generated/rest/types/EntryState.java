...
public class EntryState extends info.scce.dime.rest.RESTBaseImpl implements info.scce.dime.rest.RESTBaseType
 {
	...
	public static EntryState fromDywaEntity(final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.EntryState entity, info.scce.dime.rest.ObjectCache objectCache) {
	
		final EntryState result;
	
		if (entity instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.EntryState) {
			result = new de.ls5.dywa.generated.rest.types.EntryState();
		}
