...
public class GameTableSelectivex1_AzVAIWnXEe2xCJpb6ooUzA {
	...
	public static void copy(
		...
		if (source != null) {
			// original selective: GameGameStateSelectivex1x1x1_AzVAIWnXEe2xCJpb6ooUzA
			...
			if (!objectCache.containsSelective(cached, "GameStateGameStateSelectivex1_0WZ_gH0pEe2__HYPHEN_MINUS__urIT6LmdwA")) {
				de.ls5.dywa.generated.rest.types.GameStateGameStateSelectivex1_0WZ_gH0pEe2__HYPHEN_MINUS__urIT6LmdwA.copy(source, cached, objectCache);
			}
		...
		for (final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.TableRow
		 s : source) {
			// original selective: GameTableRowSelectivex1x2x2_AzVAIWnXEe2xCJpb6ooUzA
