...
public class TableREST {
	...
	public de.ls5.dywa.generated.rest.types.Table read_GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA(final long id) {
		...
		if (!objectCache.containsSelective(result, "GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA")) {
			de.ls5.dywa.generated.rest.types.GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA.copy(obj, result, objectCache);
		}

		return result;
	}

	public de.ls5.dywa.generated.rest.types.Table readTransient_GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA(final de.ls5.dywa.generated.rest.types.Table obj) {

		final de.ls5.dywa.generated.rest.types.Table result;
		
		if (this.objectCache.containsSelective(obj, "GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA")) {
			return obj;
		}
		else {
			result = obj;
			this.objectCache.putSelective(obj, "GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA");
		}
			...
			{
				{
					...
					if (effectiveObj.isrow_RowSet()) {
						final java.util.List<de.ls5.dywa.generated.rest.types.Row>
						 existing = effectiveObj.getrow_Row();
						java.util.List<de.ls5.dywa.generated.rest.types.Row>
						 newValue;

						newValue = new java.util.ArrayList<>(existing.size());
						for (final de.ls5.dywa.generated.rest.types.Row e: existing) {
							final de.ls5.dywa.generated.rest.types.Row fetchedValue;
						
							if (e.getDywaId() > 0) {
								// read_GameViewRowSelectivex1x1x1_Dt340GtPEe25lcL0UO2uNA
								fetchedValue = this.RowREST.read_GameViewRowSelectivex1x1x1_Dt340GtPEe25lcL0UO2uNA(e.getDywaId());
							}
							else {
								// readTransient_GameViewRowSelectivex1x1x1_Dt340GtPEe25lcL0UO2uNA
								fetchedValue = this.RowREST.readTransient_GameViewRowSelectivex1x1x1_Dt340GtPEe25lcL0UO2uNA(e);
							}
						
							newValue.add(fetchedValue);
						}

						effectiveResult.setrow_Row(newValue);
						}
					}
			}
		...
		public java.util.Set<de.ls5.dywa.generated.rest.types.Table> readAll_GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA() {
			...
			for (final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Table s : objs) {
				...
				if (!objectCache.containsSelective(cached, "GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA")) {
					de.ls5.dywa.generated.rest.types.GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA.copy(s, cached, objectCache);
				}
	...
	public void update_GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA(final de.ls5.dywa.generated.rest.types.Table value) {

		final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Table obj = this.TableController.read(value.getDywaId());
		
		this.update_GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA(value, obj);
	}

	public void update_GameViewTableSelectivex1_Dt340GtPEe25lcL0UO2uNA(final de.ls5.dywa.generated.rest.types.Table value, final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Table obj) {
		...
		if (effectiveValue.isrow_RowSet()) {
			checkVersion(value, obj);
			final java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row>
			 source = effectiveObj.getrow_Row();
			final java.util.List<de.ls5.dywa.generated.rest.types.Row>
			 actual = java.util.Optional.ofNullable(effectiveValue.getrow_Row()).orElseGet(java.util.Collections::emptyList);
			
			source.clear();
			
			for (final de.ls5.dywa.generated.rest.types.Row item : actual) {
				
				final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row entity;

				// create new
				if (item.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
					if (! (item instanceof de.ls5.dywa.generated.rest.types.Row)) {
					...
					final long id = RowREST.create(dywaName);
					item.setDywaId(id);
				
					//update_GameViewRowSelectivex1x1x1_Dt340GtPEe25lcL0UO2uNA
					this.RowREST.update_GameViewRowSelectivex1x1x1_Dt340GtPEe25lcL0UO2uNA(item);
					entity = this.RowController.read(item.getDywaId());
				}
				// create transient
					...
					entity = this.RowREST.copyToTransient(item);
				}
		...
		if (effectiveValue.isrow_RowSet()) {
			...
			for (final de.ls5.dywa.generated.rest.types.Row item : actual) {
				...
				if (item.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_CREATE_NEW) {
					...
					//update_RowSelective
					this.RowREST.update_RowSelective(item);
					entity = this.RowController.read(item.getDywaId());
				}
				// create transient
				else if (item.getDywaId() == info.scce.dime.util.Constants.DYWA_ID_TRANSIENT) {
