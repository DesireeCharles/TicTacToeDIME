...
public class TurnState extends info.scce.dime.rest.RESTBaseImpl implements info.scce.dime.rest.RESTBaseType
 {
	...
	public static TurnState fromDywaEntity(final de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.TurnState entity, info.scce.dime.rest.ObjectCache objectCache) {
	
		final TurnState result;
	
		if (entity instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.TurnState) {
			result = new de.ls5.dywa.generated.rest.types.TurnState();
		}
