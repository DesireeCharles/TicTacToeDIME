...
public class TableRowSearch implements TableRow {
	...
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.TableEntry> gettableEntry_TableEntry() {
		return (java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.TableEntry>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(23L));
	}
	...
	(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.TableEntry> object) {
			...
			this.listAttributeMap.put(dywaIdToJpqlAttr.get(23L), object);
	}
