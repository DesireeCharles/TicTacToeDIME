...
public class TableSearch implements Table {
	...
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row> getrow_Row() {
		return (java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(13L));
	}
	public void setrow_Row
	(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row> object) {
			
				for(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row)) {
