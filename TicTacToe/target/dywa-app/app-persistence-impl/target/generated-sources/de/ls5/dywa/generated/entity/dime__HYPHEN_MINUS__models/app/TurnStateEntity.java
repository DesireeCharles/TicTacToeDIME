...
@javax.persistence.Table(name = "e_TurnState__naowyw__ee2c9lz")
public class TurnStateEntity implements TurnStateInterface {
	...
	@javax.persistence.JoinColumn(name = "a_X__oylyiw__ee2c9lz")
	...
	@org.hibernate.annotations.Cascade(org.hibernate.annotations.CascadeType.PERSIST)
	@javax.persistence.JoinColumn(name = "a_O__oke5ew__ee2c9lz")
	@javax.persistence.ManyToOne
	...
	@javax.persistence.Column(name = "a_DywaDisplayName__zle_mxacee2c9lz", columnDefinition="varchar")
