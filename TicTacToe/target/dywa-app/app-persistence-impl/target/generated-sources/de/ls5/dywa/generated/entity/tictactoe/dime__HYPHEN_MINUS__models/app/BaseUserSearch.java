...
public class BaseUserSearch implements BaseUser {
	...
	public java.util.List<de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser> getconcreteUser_ConcreteUser() {
		return (java.util.List<de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(9L));
	}
	public void setconcreteUser_ConcreteUser
	(java.util.List<de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser> object) {
			
				for(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser)) {
