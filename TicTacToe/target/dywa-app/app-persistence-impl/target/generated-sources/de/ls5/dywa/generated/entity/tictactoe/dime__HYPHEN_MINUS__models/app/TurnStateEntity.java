...
public class TurnStateEntity implements TurnStateInterface {
	...
	private de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateEntity X;
	
	@de.ls5.dywa.annotations.IdRef(id = 25L)
	@org.hibernate.annotations.Cascade(org.hibernate.annotations.CascadeType.PERSIST)
	@javax.persistence.JoinColumn(name = "a_O__z97gyxpoee2egku")
	@javax.persistence.ManyToOne
	private de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateEntity O;
	
	@de.ls5.dywa.annotations.IdRef(id = 26L)
	@javax.persistence.Column(name = "a_DywaDisplayName__5io3ix0mee2_uri", columnDefinition="varchar")
	...
	@java.lang.Override
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnState getX() {
		if (this.X != null) {
			return de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnState.valueOf(this.X.getDywaName());
		}
		return null;
	}
	
	@java.lang.Override
	public void setX(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnState object) {
		this.X = object != null ? object.getEntityAs(TurnStateEntity.class) : null;
	}
	
	protected void setX_(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateEntity object) {
		this.X = object;
	}
	
	protected de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateEntity getX_() {
		return this.X;
	}
	
	
	@java.lang.Override
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnState getO() {
		if (this.O != null) {
			return de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnState.valueOf(this.O.getDywaName());
		}
		return null;
	}
	
	@java.lang.Override
	public void setO(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnState object) {
		this.O = object != null ? object.getEntityAs(TurnStateEntity.class) : null;
	}
	
	protected void setO_(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateEntity object) {
		this.O = object;
	}
	
	protected de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateEntity getO_() {
		return this.O;
	}
