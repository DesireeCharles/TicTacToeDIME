...
public class TableEntrySearch implements TableEntry {
	...
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState getentryState() {
		return de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState.forId(((de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity) this.attributeMap.get(dywaIdToJpqlAttr.get(19L))).getDywaId());
	}
	public void setentryState
	(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState object) {
			
				if (! (object instanceof de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
