...
public class ConcreteUserSearch implements ConcreteUser {
	...
	public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.BaseUser getbaseUser() {
		return (de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.BaseUser) this.attributeMap.get(dywaIdToJpqlAttr.get(6L));
	}
	...
	public de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser getdywaSwitchedTo() {
		return (de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser) this.attributeMap.get(dywaIdToJpqlAttr.get(7L));
	}
