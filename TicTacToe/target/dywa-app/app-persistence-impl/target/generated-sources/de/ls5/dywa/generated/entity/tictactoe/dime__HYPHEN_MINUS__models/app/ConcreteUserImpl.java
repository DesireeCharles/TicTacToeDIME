...
public class ConcreteUserImpl implements ConcreteUser {
	...
	@org.hibernate.annotations.AnyMetaDef(
		...
		metaValues={
			@org.hibernate.annotations.MetaValue(targetEntity=de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUserImpl.class, value="_udys4mwneewzvvv")
		}
	)
	private de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUser baseUser;
	
	@de.ls5.dywa.annotations.IdRef(id = 8L)
	@org.hibernate.annotations.Cascade(org.hibernate.annotations.CascadeType.PERSIST)
	@javax.persistence.JoinColumn(name = "a_DywaSwitchedTo__5hr04x0mee2_uri")
	@org.hibernate.annotations.Any(metaColumn=@javax.persistence.Column(name="m_DywaSwitchedTo_Type__5hr04x0mee2_uri"))
	@org.hibernate.annotations.AnyMetaDef(
		idType="long", metaType="string",
		metaValues={
	...
	private de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser dywaSwitchedTo;
	...
	@java.lang.Override
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUser getbaseUser() {
		return this.baseUser;
	}
	
	@java.lang.Override
	public void setbaseUser(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUser object) {
		if (!this.bidirectionalDirtyFlag) {
			this.bidirectionalDirtyFlag = true;
			final de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUser current = this.getbaseUser();
	...
	@java.lang.Override
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser getdywaSwitchedTo() {
		return this.dywaSwitchedTo;
	}
	
	@java.lang.Override
	public void setdywaSwitchedTo(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser object) {
