...
public class TableRowSearch implements TableRow {
	...
	@java.lang.Override
	public java.util.List<de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TableEntry> gettableEntry_TableEntry() {
		return (java.util.List<de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TableEntry>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(17L));
	}
	public void settableEntry_TableEntry
	(java.util.List<de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TableEntry> object) {
			
				for(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TableEntry p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TableEntry)) {
