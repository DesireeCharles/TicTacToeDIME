...
public class EntryStateEntity implements EntryStateInterface {
	...
	private de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity X;
	
	@de.ls5.dywa.annotations.IdRef(id = 21L)
	@org.hibernate.annotations.Cascade(org.hibernate.annotations.CascadeType.PERSIST)
	@javax.persistence.JoinColumn(name = "a_O__o_tsqxkpee2rznr")
	@javax.persistence.ManyToOne
	private de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity O;
	
	@de.ls5.dywa.annotations.IdRef(id = 22L)
	@org.hibernate.annotations.Cascade(org.hibernate.annotations.CascadeType.PERSIST)
	@javax.persistence.JoinColumn(name = "a_Empty__ppgbwxkpee2rznr")
	@javax.persistence.ManyToOne
	private de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity empty;
	
	@de.ls5.dywa.annotations.IdRef(id = 23L)
	@javax.persistence.Column(name = "a_DywaDisplayName__5h78mx0mee2_uri", columnDefinition="varchar")
	...
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState getX() {
		if (this.X != null) {
			return de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState.valueOf(this.X.getDywaName());
		}
		return null;
	}
	
	@java.lang.Override
	public void setX(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState object) {
		this.X = object != null ? object.getEntityAs(EntryStateEntity.class) : null;
	}
	
	protected void setX_(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity object) {
		this.X = object;
	}
	
	protected de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity getX_() {
		return this.X;
	}
	...
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState getO() {
		if (this.O != null) {
			return de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState.valueOf(this.O.getDywaName());
		}
		return null;
	}
	
	@java.lang.Override
	public void setO(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState object) {
		this.O = object != null ? object.getEntityAs(EntryStateEntity.class) : null;
	}
	
	protected void setO_(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity object) {
		this.O = object;
	}
	
	protected de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity getO_() {
		return this.O;
	}
	...
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState getempty() {
		if (this.empty != null) {
			return de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState.valueOf(this.empty.getDywaName());
		}
		return null;
	}
	
	@java.lang.Override
	public void setempty(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryState object) {
		this.empty = object != null ? object.getEntityAs(EntryStateEntity.class) : null;
	}
	
	protected void setempty_(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity object) {
		this.empty = object;
	}
	
	protected de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.EntryStateEntity getempty_() {
		return this.empty;
	}
