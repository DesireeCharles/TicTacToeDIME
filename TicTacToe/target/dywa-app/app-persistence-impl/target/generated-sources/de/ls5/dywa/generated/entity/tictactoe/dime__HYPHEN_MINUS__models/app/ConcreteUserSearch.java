...
public class ConcreteUserSearch implements ConcreteUser {
	...
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUser getbaseUser() {
		return (de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUser) this.attributeMap.get(dywaIdToJpqlAttr.get(7L));
	}
	public void setbaseUser
	(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUser object) {
			
				if (! (object instanceof de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.BaseUser)) {
	...
	public de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser getdywaSwitchedTo() {
		return (de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser) this.attributeMap.get(dywaIdToJpqlAttr.get(8L));
	}
	public void setdywaSwitchedTo
	(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser object) {
			
				if (! (object instanceof de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.ConcreteUser)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
