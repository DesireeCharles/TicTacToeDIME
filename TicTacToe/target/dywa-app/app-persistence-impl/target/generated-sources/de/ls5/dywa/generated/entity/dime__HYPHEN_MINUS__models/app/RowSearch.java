...
public class RowSearch implements Row {
	...
	static {
		java.lang.Class<?> targetClass = RowImpl.class;
	...
	public RowSearch(java.lang.String name) {
	...
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Entry> getentry_Entry() {
		return (java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Entry>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(14L));
	}
	public void setentry_Entry
	(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Entry> object) {
			
				for(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Entry p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Entry)) {
