...
@javax.persistence.Table(name = "t_Table__vsmzmgtiee25lcl", indexes={@javax.persistence.Index(columnList="meta_inheritance")})
...
public class TableImpl implements Table {
	...
	@javax.persistence.JoinTable(name="r_Table_Row__fezdywtiee25lcl", joinColumns = { @javax.persistence.JoinColumn(name = "r1_Table_id") }, inverseJoinColumns = { @javax.persistence.JoinColumn(name = "r2_Row_id") })
	@org.hibernate.annotations.ManyToAny(metaColumn=@javax.persistence.Column(name="m_Row_Type__fezdywtiee25lcl"))
	@org.hibernate.annotations.AnyMetaDef(
		idType="long", metaType="string",
		metaValues={
			@org.hibernate.annotations.MetaValue(targetEntity=de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.RowImpl.class, value="_ytbhuwtiee25lcl")
		}
	)
	private java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row> row  = new java.util.ArrayList<>();
	...
	@java.lang.Override
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row> getrow_Row() {
		return this.row;
	}
	
	@java.lang.Override
	public void setrow_Row(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Row> object) {
		this.row = object;
	}
