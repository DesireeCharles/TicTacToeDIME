...
public enum TurnState implements de.ls5.dywa.generated.util.Identifiable, de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateInterface {
	X(33L), O(34L);
	...
	public void setX(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnState newValue) {
		loadOrRefresh();
	...
	public void setO(de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnState newValue) {
		loadOrRefresh();
		if (this.internalDelegate != null) {
	...
	private void loadOrRefresh() {
		...
		if (this.internalDelegate == null || !em.contains(this.internalDelegate)) {
			javax.persistence.TypedQuery<de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateInterface> query = em.createQuery(
				"SELECT ent " +
				"FROM de.ls5.dywa.generated.util.EnumMapping map " +
					"JOIN de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateEntity ent " +
					"ON (map.objectId = ent.id_) " +
				"WHERE map.enumId = :id",
				de.ls5.dywa.generated.entity.tictactoe.dime__HYPHEN_MINUS__models.app.TurnStateInterface.class);
