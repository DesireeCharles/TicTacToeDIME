...
public class PublicHomeGUIResumer extends info.scce.dime.process.GUIResumer {
	...
	@javax.ws.rs.POST
	@javax.ws.rs.Path("Login/branch/public")
	@javax.ws.rs.Produces(javax.ws.rs.core.MediaType.APPLICATION_JSON)
	@javax.ws.rs.Consumes(javax.ws.rs.core.MediaType.APPLICATION_JSON)
	public javax.ws.rs.core.Response continueLoginBranch(info.scce.dime.rest.gui.model._MF6_kE_LEeauEZ95mLTQ7gBranch output) {
		
		checkAuthentication(output.getCallStack(),"_LmrS0Ej8EeaK4_MRcoLfnw/Login");
		
		
		final info.scce.dime.gui.dime__HYPHEN_MINUS__models.gui.publichome.PublicHome_LmrS0Ej8EeaK4_MRcoLfnwResult guiResult = 
		new info.scce.dime.gui.dime__HYPHEN_MINUS__models.gui.publichome.PublicHome_LmrS0Ej8EeaK4_MRcoLfnwResult("Login");
