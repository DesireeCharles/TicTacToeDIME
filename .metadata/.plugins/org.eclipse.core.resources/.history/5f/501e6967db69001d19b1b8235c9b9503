...
public class BaseUserSearch implements BaseUser {
	...
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser> getconcreteUser_ConcreteUser() {
		return (java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(4L));
	}
	...
	(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.ConcreteUser> object) {
			...
			this.listAttributeMap.put(dywaIdToJpqlAttr.get(4L), object);
	}
	@java.lang.Override
	public java.lang.String getpassword() {
		return (java.lang.String) this.attributeMap.get(dywaIdToJpqlAttr.get(5L));
	}
	...
	public de.ls5.dywa.generated.util.FileReference getimage() {
		return new de.ls5.dywa.generated.util.FileReference((de.ls5.dywa.generated.util.DomainFile) this.attributeMap.get(dywaIdToJpqlAttr.get(6L)));
	}
	...
	(de.ls5.dywa.generated.util.FileReference object) {
			...
			this.attributeMap.put(dywaIdToJpqlAttr.get(6L), object != null ? object.getDelegate() : null);
	}
	@java.lang.Override
	public java.lang.String getfirstName() {
		return (java.lang.String) this.attributeMap.get(dywaIdToJpqlAttr.get(7L));
	}
